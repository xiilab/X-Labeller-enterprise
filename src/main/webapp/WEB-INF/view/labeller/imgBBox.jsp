...
<head>
    ...
    <style>
        ...
        #accordionSidebar a.nav-link span {
            width: 168px;
            display: block;
        }
        ...
        #imgBBox a.next_page, a.prev_page {
            cursor: pointer;
        }

        #imgBBox .pagination input.page-link {
            height: 30px;
            width: 30px;
            padding: 0 0 0 8px;
        }
        ...
        #imgBBox .search_all_wp .search_all_wrap {
        ...
        #imgBBox .search_all_wp .search_all_wrap .search_cate_list {
            cursor: pointer;
        }

        #imgBBox .search_all_wp .search_all_wrap .search_cate_list:hover {
            color: red;
        }
        ...
        /* jh.sa 210520 */
        #imgBBox .label_wrap .cate_wp .visibility {
            width: 20px;
            height: 20px;
            display: inline-block;
            position: relative;
            top: 0px;
            background: url('${pageContext.request.contextPath}/resources/images/labeller/ico-eye-on-light.png') center no-repeat;
        }

        #imgBBox .label_wrap .cate_wp .visibility.off,
        #imgBBox .label_wrap .cate_wp .visibility:hover {
            opacity: 1;
            background: url('${pageContext.request.contextPath}/resources/images/labeller/ico-eye-off-light.png') center no-repeat;
            cursor: pointer;
        }

        #imgBBox .video_wrap .canvas {
            width: 800px;
            height: 400px;
        ...
        #imgBBox .video_wrap .prog_bar > div {
            color: #020b44;
        }

        #imgBBox .video_wrap .prog_bar .btn_wrap {
            width: 400px;
            margin-top: 0;
        }

        /*       	.video_wrap .prog_bar .btn { color:#020b44; border-radius:50%; } */
        #imgBBox .video_wrap .prog_bar input.curr_frame {
            width: 50px;
            height: 15px;
            margin-right: 0px;
        }

        #imgBBox .video_wrap .prog_bar .save_btn_wrap {
            width: 260px;
        }

        #imgBBox .label_wrap .btn_wrap {
            margin: 0;
            padding-bottom: 1px;
        ...
        @media (min-height: 960px) {
            ...
            #imgBBox .label_wrap .category_wrap {
                max-height: 785px;
            }
        }
        ...
        #imgBBox .label_wrap .category_wrap .cate_wp {
        ...
        #imgBBox .label_wrap .category_wrap .cate_wp .crop_wrap {
            width: 180px;
            height: 105px;
            align-items: center;
            display: flex;
        ...
        #imgBBox .label_wrap .category_wrap .cate_wp .crop_img {
            position: relative; /* width:180px; height:105px; */
        }

        #imgBBox .label_wrap .category_wrap .cate_wp.selected {
        ...
        #imgBBox .label_wrap .category_wrap .cate { /*width:5em;*/ /* width:60px; */
            border: 1px solid #eeeeee;
            text-align: center;
        ...
        /* 		#edit h.lee */
        #imgBBox .next_data_wrap {
            border: 1px solid white;
            width: 35px;
            height: 598px;
        }

        #imgBBox .prev_data_wrap:hover {
            cursor: pointer;
            background-color: #eee;
            opacity: 0.3;
        }

        #imgBBox .next_data_wrap:hover {
            cursor: pointer;
            background-color: #eee;
            opacity: 0.3;
        }

        #imgBBox .page_title_wrap {
            position: relative;
            top: 20px;
            left: 90px;
            display: inline;
        ...
        #imgBBox .page_title_wrap span:first-child {
            font-size: 13px;
        }

        #imgBBox .page_title_wrap span:nth-child(2) {
            color: #4c84ff;
            font-size: 14px;
        }
        ...
        #imgBBox .cate_wp input {
            width: 165px;
            padding: 10px;
            margin-top: 3px;
        }

        #imgBBox .save_btn_wrap {
            justify-content: center;
            position: absolute;
            bottom: 0;
            padding: 26px 0;
        ...
        #imgBBox .save_btn_wrap .save:hover {
            background-color: #3A71E9;
        }
        ...
        #imgBBox .position_wrap {
            width: 100px;
            margin-right: 20px;
        }

        #imgBBox .position_wrap .position-value {
            width: 40px;
            padding: 5px;
        }

        #imgBBox .position_wrap .total_count {
            display: inline-block;
        }
        ...
        #imgBBox .list_btn_wrap {
            width: 100px;
            margin-left: 20px;
        }

        #imgBBox .list_btn_wrap .data_list_btn {
            width: 30px;
            height: 30px;
            margin-right: 30px;
            background: url(images/icon_filter_normal.png) right;
            cursor: pointer;
        }

        /* panel label */
        #imgBBox .btn_wrap .visible {
            width: 18px;
            height: 18px;
            position: relative;
            left: -145px;
        ...
        .card, .container-fluid, #wrapper, #content-wrapper, #content {
            height: 100%;
        }

        #imgBBox section.enrichment .empty_wrap {
            margin: 0 auto;
            text-align: center;
            margin-top: 300px;
            color: #777777;
        ...
        #imgBBox section.enrichment .empty_wrap .no_image {
            margin-bottom: 17px;
        ...
        #imgBBox section.enrichment .empty_wrap .eng_text {
            margin-bottom: 3px;
            font-size: 16px;
        }

        #imgBBox section.enrichment .empty_wrap .kor_text {
            font-size: 12px;
        }
        ...
        #imgBBox .quick_wrap .quick_btn_wrap {
            display: flex;
            margin-left: 25.5px;
        }
        ...
        #imgBBox .checkpoint_close {
            ...
            display: inline-block;
            cursor: pointer;
            background: url("${pageContext.request.contextPath}/resources/images/btn-popup-close-normal.png");
        }
        ...
        #imgBBox .checkBtn {
            ...
            width: 16px;
            height: 16px;
            background: url("${pageContext.request.contextPath}/resources/images/icon_gpu_check.png") no-repeat center;
        }
        ...
        #imgBBox select {
            ...
            font: 400 11px system-ui;
            background: url("${pageContext.request.contextPath}/resources/images/select_arrow.png") #fff no-repeat 97% 50%/10px;
        }
        ...
        #imgBBox .tooltip_wrap {
            ...
            position: relative;
            top: 4px;
            background: url("${pageContext.request.contextPath}/resources/images/btn_help_nor.png") no-repeat;
        }
        ...
        /* #imgBBox .checkBtn { display:inline-block; width: 16px; height: 16px; background: url("


        ${pageContext.request.contextPath}   /resources/images/icon_gpu_check.png") no-repeat center; } */
        ...
        #imgBBox .quick_wrap select {
            padding: 5px 20px;
        }

        #imgBBox .data_list_header {
            margin-top: -10px;
        }

        #imgBBox .data_list_header .close_btn {
            font-size: 24px;
            cursor: pointer;
            position: relative;
            top: -5px;
        ...
        #imgBBox .data_list_header .close_btn:hover {
            color: #4c84ff;
        }
        ...
        #imgBBox .no_label div:nth-of-type(1) {
            width: 53px;
            height: 53px;
            margin: 0 auto;
            margin-bottom: 11px;
            background: url('${pageContext.request.contextPath}/resources/images/img_nodata.png') no-repeat;
            opacity: 0.4; /*  */
        }

        #imgBBox .no_label div:nth-of-type(2) {
            font-size: 16px;
            font-weight: 300;
            margin-bottom: 3px;
        }

        #imgBBox .no_label div:nth-of-type(3) {
            font-size: 12px;
            font-weight: 300;
        }
        ...
        #imgBBox section.tag .tag_margin {
            margin: 0 auto;
            padding: 10px;
        }

        #imgBBox section.tag .tag_total {
            color: #777;
            font-weight: 400;
            padding: 20px;
        }

        #imgBBox section.tag .tag_wrap {
            width: 100%;
            height: 90px;
            margin-top: 1px;
        ...
        #imgBBox section.tag .tag_wrap .content {
            width: 100%;
            height: auto;
            max-height: 75px;
            overflow-y: scroll;
        ...
        #imgBBox section.tag .tag_wrap .content::-webkit-scrollbar {
            display: none;
        }

        #imgBBox section.tag .tag_wrap .tag {
            width: 81px;
            margin: 10px 5px;
            line-height: 32px;
            background: #f4f7fc;
        ...
        #imgBBox section.tag .tag_wrap .tag.selected {
            background-color: #4c84ff;
            border-color: #2b65e6;
            color: #fff;
        ...
        #imgBBox .hover_box div {
            font-family: Open_Sans;
            font-size: 13px;
            color: #555555;
        }

        #imgBBox .hover_div div {
        ...
        #imgBBox .semi_auto_labelling_wrap {
            display: flex;
            align-items: flex-end;
            margin-right: 25.5px;
        }

        #imgBBox .semi_auto_labelling_wrap .wrap {
            display: flex;
            flex-direction: column;
            margin-right: 10px;
        }

        #imgBBox .semi_auto_labelling_wrap .wrap label {
            margin-bottom: 5px;
        }

        #imgBBox .semi_auto_labelling_wrap .wrap select {
            width: 200px;
        }
    </style>
</head>
                    ...
                    <section class="enrichment">
                        <div class="header_wrap flex sb">
                            <div class="page_title_wrap">
                                <span>색인 작업 화면</span> <span>|</span> 이미지 바운딩 박스
                            </div>
                        </div>
                        ...
                        <div class="img_list_wrap flex sb"> <!-- Image Slide area start -->
                            ...
                            <div class="position_wrap">
                                <input type="text" class="position-value" value="1"
                                       onKeyPress="return checkNum2(event);"/>
                            ...
                            <div class="data_list_wrap">
                                ...
                                <div class="list_table">
                                    <div class="h_wrap flex">
                                        ...
                                        <div class="id">이미지ID</div>
                                        <div class="path">파일명</div>
                                        <div class="label_cnt">라벨 개수</div>
                                    </div>
                                    <ul class="c_wrap">
                                    </ul>
                        ...
                        <div class="quick_wrap flex"> <!-- Quick Training & Inference Btn area start -->
                            <div class="quick_btn_wrap">
                                <div id="quick_training_btn" class="quick_btn filter_color">빠른 학습</div>
                                <div id="quick_inference_btn" class="quick_btn filter_color">빠른 추론</div>
                            </div>
                            ...
                            <div class="semi_auto_labelling_wrap">
                                <div class="wrap">
                                    ...
                                    <select id="project_option">
                                        <option selected disabled>선택할 수 있는 항목이 없습니다.</option>
                                    </select>
                                </div>
                                <div class="wrap">
                                    <label>태스크</label>
                                ...
                                <div id="semi_auto_inference_btn" class="quick_btn filter_color">반자동 라벨링</div>
                            </div>

                            <!-- Quick Training -->
                            <div id="quick_training" class="quick_training filter_color">
                                <div class="quick_title">
                                    빠른 학습<span class="quick_close fr"></span>
                                </div>
                                <div class="input_wrap flex">
                                    <label>데이터세트 패키지명</label>
                                    <input type="text" name="annotation_name" data-length="100"
                                           placeholder="데이터세트 패키지명을 입력해주세요." onkeyup='noSpaceForm(this);'
                                           onchange='noSpaceForm(this);'>
                                </div>
                                <div class="input_wrap flex">
                                    <label>프로젝트</label> <select id="project_result"
                                                                class="project_result" name="project_result">

                                </select> <span class="add_project_btn">+</span>
                                </div>
                                <div class="input_wrap flex">
                                    <label>태스크명</label> <input type="text" name="task_name"
                                                               placeholder="태스크명을 입력해주세요." data-length="100"
                                ...
                                <div class="input_wrap flex">
                                    <label>알고리즘</label> <select id="algorithm_result"
                                ...
                                <div id="add_project" class="add_project">
                                    ...
                                    <input type="text" name="title"
                                           placeholder="프로젝트 명을 입력해주세요." data-length="100" onkeyup='noSpaceForm(this);'
                                           onchange='noSpaceForm(this);'>
                                    <textarea class="contents_area" name="contents"
                                              data-length="200"
                                              placeholder="프로젝트 설명을 입력해주세요."></textarea>
                                    <div class="side_btn_wrap flex">
                                        <div class="cancel_btn">취소</div>
                                        <div class="add_btn">생성</div>
                                    </div>
                            ...
                            <div id="quick_inference" class="quick_inference filter_color">
                                <div class="quick_title">
                                    빠른 추론<span class="quick_close fr"></span>
                                </div>
                                <div class="csv_name_input_wrap">
                                    <!-- 							<span>output file name</span> -->
                                    <input type="text" name="csv_title"
                                           placeholder="추론 결과 파일명을 입력해주세요." onkeyup='noSpaceForm(this);'
                                           onchange='noSpaceForm(this);'/>
                                </div>
                    ...
                    <section class="label_tag">
                        <section class="tag">
                            <div class="btn_wrap flex sb">
                                <div class="label_title">태그(색인목록) - 개수: <span></span></div>
                        ...
                        <section class="label">
                            ...
                            <div class="label_wrap ">
                                <div class="btn_wrap flex sb">
                                    <div class="label_title">라벨 (<span></span>)</div>
                                    <!--                					<div class="visible on"></div> -->
                                    <button type="button" class="btn btn-primary add filter_color">+ 라벨 추가</button>
                                </div>
...
// 							$("#labeller-video .vjs-progress-control").hide();
                    ...
                    if (tempRect.left < 0 && pointer.x < 0.5) {
                        tempRect.left = 0;
                        evt.target.left = tempRect.left;
                        tempRect.width = evt.target.aCoords.br.x - 0;
                        evt.target.scaleX = tempRect.width / evt.target.width;
                        // console.log("evt.target.scaleX::" + evt.target.scaleX);
                    }

                    if (tempRect.top < 0 && pointer.y < 0.5) {
                        tempRect.top = 0;
                        evt.target.top = tempRect.top;
...
//		 					$("#imgBBox .description_wrap").html("");
            ...
            semiAutoLabelling() {
                ...
                // 나머지 selectBox 초기화
                let resetHtml = '<option selected disabled>선택할 수 있는 항목이 없습니다.</option>'
...
//	 						checkpoint_view.html("Selected Checkpoint :" + selected_cp_name);
            ...
            trainingConfigListener: function () {
                ...
                var that = imgBBoxQuick;
                var validationParam = $("#imgBBox #training_config .config_wrap input[validationParam]");
                ...
                validationParam.off("focusout").on("focusout", function (e) {
                    ...
                    var targetObj = $('#imgBBox #training_config .config_wrap input[name=' + targetName + ']');
            ...
            inferenceConfigListener: function () {
                ...
                var that = imgBBoxQuick;
                var validationParam = $("#imgBBox #inference_config .config_wrap input[validationParam]");
                ...
                validationParam.off("focusout").on("focusout", function (e) {
                    ...
                    var targetValue = e.target.value;
                    var targetName = e.target.name;
                    var targetObj = $('#imgBBox #inference_config .config_wrap input[name=' + targetName + ']');
...
// 									that.root.computed.initEnrichment();
            ...
            getTaskOptionList: function (projectId) {
                ...
                var ajaxData = {
                    ...
                    label_type: "IMAGE_BBOX" // IMAGE_BBOX, IMAGE_SEGMENTATION, VIDEO_BBOX
                }
...
//	 						that.root.bind.removeEmptyData($("#imgBBox .checkpoint_list .list_wrap"));
            ...
            renderProjectSelectOption(resultData) {
                ...
                let selectTarget = $("#imgBBox select#project_option");
                selectTarget.html("");

                let html = ""
                if (resultData.length > 0) {
                    html = "<option selected disabled>프로젝트를 선택해주세요.</option>";
                    ...
                    html += "<option selected disabled>선택할 수 있는 항목이 없습니다.</option>"
                }
            ...
            renderTaskSelectOption(resultData) {
                ...
                let selectTarget = $("#imgBBox select#task_option");
                selectTarget.html("");

                let html = ""
                if (resultData.length > 0) {
                    html = "<option selected disabled>태스크를 선택해주세요.</option>";
                    for (let i = 0, len = resultData.length; i < len; i++) {
            ...
            renderModelSelectOption(resultCode, resultData) {
                ...
                let selectTarget = $("#imgBBox select#model_option");
                selectTarget.html("");

                let html = ""
                if (resultCode == "200" && resultData.length > 0) {
                    html = "<option selected disabled>모델을 선택해주세요.</option>";
                    for (let i = 0, len = resultData.length; i < len; i++) {
