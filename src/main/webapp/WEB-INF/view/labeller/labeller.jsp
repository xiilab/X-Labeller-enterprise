...
<head>
	...
	<style>
		...
		#labeller { min-height: calc(100% - 66px); }
		#labeller .min_w1440 { position: absolute; height: 100%; }
		#labeller .contents { height: 100%; }
		#labeller .contents>div { height: 100%; }
		#labeller .drop_area{width: 100%; }
...
<body>
	<div class="container" id="labeller">
		<div class="min_w1440">
			<div class="contents flex">
				...
				<div class="drop_area">
					<div class="section info selected">
						<jsp:include page="/labeller/main" flush="false" />
					</div>
					<div class="section upload">
						<jsp:include page="/labeller/upload" flush="false" />
					</div>
					<div class="section modify">
						<jsp:include page="/labeller/modify" flush="false" />
					</div>
					<div class="section addImg">
						<jsp:include page="/labeller/addImg" flush="false" />
					</div>
<!-- 					<div class="section enrichment"> -->
<%-- 						<jsp:include page="/labeller/enrichment" flush="false" /> --%>
<!-- 					</div> -->
					...
					<div class="section labelList">
						<jsp:include page="/labeller/labelList" flush="false" />
					</div>
					<div class="section imgBBox">
						<jsp:include page="/labeller/imgBBox" flush="false" />
					</div>
					<div class="section imgSeg">
						<jsp:include page="/labeller/imgSeg" flush="false" />
					</div>
					<div class="section imgLine">
						<jsp:include page="/labeller/imgLine" flush="false" />
					</div> 
					<div class="section videoBBox">
						<jsp:include page="/labeller/videoBBox" flush="false" />
					</div> 
					<div class="section list2">
						<jsp:include page="/labeller/dataList2" flush="false" />
					</div>		
					<div class="section imgBBoxList">
						<jsp:include page="/labeller/imgBBoxList" flush="false" />
					</div>
					<div class="section imgSegList">
						<jsp:include page="/labeller/imgSegList" flush="false" />
					</div>
					<div class="section videoBBoxList">
						<jsp:include page="/labeller/videoBBoxList" flush="false" />
					</div>						
				</div>
			</div>
		</div>
...
// 			var html = "<div class='flex'><div class='new_btn filter_color'>New +</div><div class='import_btn filter_color'>Import</div></div>";
		...
		event : {
			...
			modify : function() {
				...
				var selected_nodes = wsObj["labeller"].dir.getSelectedNodes();
				var data_modified = that.dataModifiedCheck();        // jh.sa 210129
...
// 						}
						var temp = that.pt.find(".drop_area > .section.selected");
						if(temp.length > 0){
							labeller.pt.find(".drop_area > .section").removeClass("selected");
							var node = ".section.info";
							labeller.pt.find(node).addClass("selected");							
						};
						//////////////////////////
			...
			that.pt.find("div.section").removeClass("selected");
				switch (label_type){
					...
					case "VIDEO_BBOX":
						...
						break;
					case "IMAGE_LINE":
						console.log("IMAGE_LINE");
						var node = ".section.imgLine";
						that.pt.find(node).addClass("selected");
						imgLine.datasetInit(nodes[0].id);
						break;
				}
		//} 
...
// 				videoBBox.init(nodes);
		...
		getDatasetById : function(where){
			...
			var ajaxData = { dataset_id : pNode.id };
