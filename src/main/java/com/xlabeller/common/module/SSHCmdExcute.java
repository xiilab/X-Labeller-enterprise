...
public class SSHCmdExcute{
	private String userName;
	private int port;
	private String host;
	private String pw;
	private Session session;
	private static Logger logger = Logger.getLogger(SSHCmdExcute.class);
	
	public SSHCmdExcute(String userName, int port, String host, String pw) {
